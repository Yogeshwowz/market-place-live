...
class Home extends CI_Controller
{
    ...
    public function index()
    {
        $data['title'] = 'Home';
			...
			if ($user['code'] === 200){				
			$this->session->set_userdata('login',true);				$this->session->set_userdata('user_profile',$user['data']);							
			}		
			}else
			{			
    ...
    {
        $data['title'] = 'Search Result';
		$data['contact'] = $this->administrator_model->contact();
        $this
            ->load
            ->view('template/frontend/header');
        $this
