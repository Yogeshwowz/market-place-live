                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                          ...
                          <li class="breadcrumb-item"><a href="<?php echo base_url();?>admin-users">Manage Admin Users</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col">
		 <div class="card">
          <div class="card-body">
            <!-- Card header -->
             <div class="row">
                <form  action="<?php echo base_url();?>new-admin" method="post" role="form" novalidate=""   id="my_admin_form">
					<div  id="add-admin-form-success" class="alert alert-success alert-dismissible fade show" role="alert">
					<span class="alert-icon"><i class="ni ni-like-2"></i></span>
					<span class="alert-text">New admin has been added successfully</span>
                  ...
                  <div class="form-row">
                    <div class="col-md-6 ">
                      ...
                      <input name="account_name" type="text" class="form-control" id="validationCustom01" placeholder="Business name"  required="true">
                    ...
                    <div class="col-md-6 ">
                      ...
                      <input name="location" type="text" class="form-control" id="validationCustom02" placeholder="City Name &Region name"  required="true">
                      <div class="invalid-feedback">
				 ...
				 <div class="form-row pt-3">
                    <div class="col-md-6">
                      ...
                      <input  name="mailing_address" type="text" class="form-control" id="validationCustomUsername1" placeholder="Mailing Address" aria-describedby="inputGroupPrepend" >
