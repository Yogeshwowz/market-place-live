        ...
        <div class="col">
		 <div class="card">
          <div class="card-body">
            <!-- Card header -->
             <div class="row">
                <form  action="<?php echo base_url();?>new-admin" method="post" role="form" novalidate=""   id="my_category_form">
                    ...
                    <div class="col-md-6 ">
                      ...
                      <input name="category" type="text" class="form-control" id="validationCustom01" placeholder="Category name"  required="true">
