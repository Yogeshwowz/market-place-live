            ...
            <div class="col-lg-6 col-7">
               ...
               <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                     ...
                     <li class="breadcrumb-item"><a href="#">Manage Inventory Stock</a></li>
                  </ol>
               </nav>
            </div>
         </div>
   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col">
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <form  action="#" method="post" role="form" novalidate=""   id="my_stock_form">
                        <div class="col-md-6 com-cls-8" id="catDiv">
                           <div class="row">
                              <div class="col-md-8 com-cls-8">
                                 <label class="form-control-label" for="category">Category </label>
                                 <select name="selectcategory" class="form-control search-category cat-common-filter" id="selectcategory">
                        ...
                        <div class="col-md-6 com-cls-8 pt-3 by-default-hide" id="program_levelDiv">
                           ...
                           <select name="program_level" class="form-control search-program-levels common-filter" id="program_level">
                        ...
                        <div class="col-md-6 com-cls-8 pt-3 by-default-hide" id="themeDiv">
                           <div class="row">
                              <div class="col-md-8 com-cls-8">
                                 <label class="form-control-label" for="theme_year">Theme Year </label>
                                 <select name="selecttheme_year" class="form-control search-theme-year" id="selecttheme_year">
                        ...
                        <div class="col-md-6  com-cls-8 pt-3 by-default-hide" id="locationDiv">
                           <div class="row">
                              <div class="col-md-8 com-cls-8">
                                 <label class="form-control-label" for="select_location">Location</label>
                                 <select name="select_location" class="form-control search-location" id="select_location">
                     ...
                     <div class="col-md-7 com-cls-8 pt-3 by-default-hide prizes-elementary">
                      ...
                      <div class="col-md-7 com-cls-8 pt-3 by-default-hide prizes-elementary">
                       ...
                       <div class="col-md-7 com-cls-8 pt-3 by-default-hide prizes-middle">
                        ...
                        <?php /*<div class="col-md-6 com-cls-8 pt-3" id="themeDiv">
                           <div class="row">
                              <div class="col-md-8 com-cls-8">
                                 <label class="form-control-label" for="theme_year">Theme Year </label>
                                 <select name="selecttheme_year" class="form-control search-theme-year" id="selecttheme_year">
            ...
            <div class="col-md-6 com-cls-8 pt-3" id="prize_levelDiv">
            <label class="form-control-label" for="prize_level">Prize Level </label>
            <select name="prize_level" class="form-control search-prize-level" id="prize_level">
            <option value="">Select Prize Level</option>
            <?php foreach($prize_level as $key=>$value){?>
            <option value="<?php echo $key;?>"><?php echo $value;?></option>
            <?php } ?>
            </select>
            </div>*/?>
            <div class="col-md-12  com-cls-8 pt-3">
            <input  class="btn btn-primary mt-3" type="submit" name="add_inventorystock" Value="Submit">
            </div>
            <!----------------------Add More Category----------------->
