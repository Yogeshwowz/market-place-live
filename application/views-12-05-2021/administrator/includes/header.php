    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link <?php if(in_array('dashboard',$url)){ echo "active"; }?>" href="<?php echo base_url();?>dashboard" aria-controls="navbar-dashboards">
         ...
         <li class="nav-item">
              <a class="nav-link <?php if(in_array('profile',$url)){ echo "active"; }?>" href="<?php echo base_url();?>profile" >
