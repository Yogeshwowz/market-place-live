            ...
            <div class="col-lg-6 col-7">
               ...
               <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                     ...
                     <li class="breadcrumb-item"><a href="#">Manage Inventory Stock Value</a></li>
                  </ol>
               </nav>
            </div>
         </div>
                        ...
                        <div class="col-md-12 com-cls-8" id="catDiv">
                           <div class="row">
                              <div class="col-md-6 com-cls-8">
                                 ...
                                 <select name="selectcategory" class="form-control search-category category-stock-filter-value" id="selectcategory">
                     ...
                     <div class="col-md-7 com-cls-8 pt-3 by-default-hide prizes-elementary">
                      ...
                      <div class="col-md-7 com-cls-8 pt-3 by-default-hide prizes-elementary">
                       ...
                       <div class="col-md-7 com-cls-8 pt-3 by-default-hide prizes-middle">
						...
						<div class="col-md-12 com-cls-8 pt-3 by-default-hide tickers-stock"></div>
