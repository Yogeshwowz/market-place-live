              ...
              <table class="table table-flush" id="datatable-basic">
				...
				<?php foreach($users as $users) { ?>
                  <tr>
                    ...
                    <td><a  class="aeditclass" href="<?php echo base_url();?>edit-user/<?php echo base64_encode($users->id)?>">Edit</a>|<span rel="<?php echo $users->id;?>" class="delete-admin-user">Delete</span> |
