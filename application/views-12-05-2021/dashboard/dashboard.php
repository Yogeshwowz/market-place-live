                    ...
                    <div class="main_box mb-4">
                        ...
                        <div class="box_body main_line p_20">
                            ...
                            <div class="d-flex flex-column black_border px-4 py-3 my-4 br_10">
                               <?php if(empty($userprofile['amount'])) { ?> <p class="pb-3">You have No Active Plan, Please upgrade to a premium plan to get your profile activated faster and start sending proposals to investors and acquirers</p><?php } ?>
							   <?php if(empty($userprofile['amount'])) { ?>
