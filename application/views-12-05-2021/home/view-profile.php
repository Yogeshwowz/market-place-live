                    ...
                    <a href="#">
                        <div class="c_box d-flex flex-column w-100">
                            ...
                            <div class="d-flex justify-content-between bg_color p-2 mb_2">
                                ...
                                <p><span>SGD</span> <?php if(!empty($allsellerProfile->field_12)) { echo $allsellerProfile->field_12; }?></p>
                            </div>
                            <div class="d-flex justify-content-between bg_color p-2 mb_2">
                                <p>Yearly Sales<span><i class="fa fa-info-circle pl-1" aria-hidden="true"></i></span></p>
                                <p><?php if(!empty($allsellerProfile->field_13)) { echo $allsellerProfile->field_13; }?></p>
                            </div>
                            <div class="d-flex justify-content-between bg_color p-2 mb_2">
                                <p>Selling Price<span><i class="fa fa-info-circle pl-1" aria-hidden="true"></i></span></p>
                                <p><span>SGD</span> <?php if(!empty($allsellerProfile->tentative_selling)) { echo $allsellerProfile->tentative_selling; }?></p>
                            </div>
