   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-md-8 pr-5">
			...
			<span class="alert-icon"><i class="ni ni-like-2"></i></span>               <span class="alert-text">Thank you for providing the basic details of your profile. To publish your profile publicly please select the plans below.</span>               
            ...
            <form  id="advisor-profile-frm" method="POST" action="" role="form" novalidate=""enctype="multipart/form-data" >
               <div class="pro_box bg_white my-4">
                  ...
                  <hr>
                  <div class="row">
                     <div class="col-md-6 mb-2 justify-content-between"><label class="w-100 mb-1 " for="your_name">Your Name</label>              
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 mb-2">
                        <select   class="w-100 p-1 select_field_1 js-example-basic-single" name="field_1" id="field_1">
						   ...
						   <option value="3" <?php if(!empty($userprofile['field_1'])) {if($userprofile['field_1']==3) { echo"selected";}}?>>Lawyer</option>
						   <option value="3" <?php if(!empty($userprofile['field_1'])) {if($userprofile['field_1']==3) { echo"selected";}}?>>Consultant</option>
						   <option value="3" <?php if(!empty($userprofile['field_1'])) {if($userprofile['field_1']==3) { echo"selected";}}?>>Broker</option>
                        </select>
                     </div>
					 <div class="col-md-6 mb-2">                        
                     ...
                     <div class="col-md-6 mb-2">                        
					 <input required='true'  class="w-100 p-1 px-2" type="text" name="your_company" value="<?php if(!empty($userprofile['your_company'])) {echo  $userprofile['your_company'];}?>">                     
					 </div>
                     <div class="col-md-6 mb-2">                        
					 <label class="">Your designation</label>                     
					 </div>
                     <div class="col-md-6 mb-2">                        
					 <input  required='true' class="w-100 p-1 px-2" type="text" name="field_7" id="field_7" value="<?php if(!empty($userprofile['field_7'])) {echo  $userprofile['field_7'];}?>">                     
					 </div>
                     <div class="col-md-6 mb-2">                        
					 <label class="">Company website</label>   </div>
                     <div class="col-md-6 mb-2">                        
					 <input required='true' class="w-100 p-1 px-2" type="text" name="field_8" id="field_8" value="<?php if(!empty($userprofile['field_8'])) {echo  $userprofile['field_8'];}?>">                     
					 </div>
					  <div class="col-md-6 mb-2">                        
					 <label class="">LinkedIn profile </label>   </div>
                     <div class="col-md-6 mb-2">                        
					 <input required='true' class="w-100 p-1 px-2" type="text" name="field_10" id="field_10" value="<?php if(!empty($userprofile['field_10'])) {echo  $userprofile['field_10'];}?>">                     
					 </div>
                     <div class="col-md-6 mb-2">                        
					 <label class="">Your company's sector</label>                     </div>
                     <div class="col-md-6 mb-2">
                     ...
                     <div class="col-md-6 mb-2">                        
					 <textarea  required='true' class="form-control" rows="3" name="field_6" id="field_6"><?php if(!empty($userprofile['field_6'])) {echo  $userprofile['field_6'];}?></textarea>                     </div>
                   
                     <div class="col-md-6 mb-2">                        
					 <label class="">Your current location</label>                     </div>
                     <div class="col-md-6 mb-2">                        
					 <input required='true' class="w-100 p-1 px-2" type="text" name="field_5" id="field_5" value="<?php if(!empty($userprofile['field_5'])) {echo  $userprofile['field_5'];}?>">                     
					 </div>
                     <div class="col-md-6 mb-2">                        
					 <label class="">Select industries Preference you are interested in</label>                     
					 </div>
                     <div class="col-md-6 mb-2">
                        <!--<input class="w-100 p-1 px-2" type="text" name="field_2" id="field_2" value="<?php //if(!empty($userprofile['field_2'])) {echo  $userprofile['field_2'];}?>">-->                        <?php if(!empty($userprofile['field_2'])) {  
                     ...
                     <div class="col-md-6 mb-2">                        
					 <input required='true' class="w-100 p-1 px-2" type="text" name="field_3" id="field_3" value="<?php if(!empty($userprofile['field_3'])) {echo  $userprofile['field_3'];}?>">                     
					 </div>
                     ...
                     <div class="col-md-6 mb-2">
                        <div id="documents-preview" class="row">
                           <?php if(!empty($Docimages)){                              $showpath =base_url()."assets/img/";                                                            foreach($Docimages as $Docimages){                                                            $ext = pathinfo($Docimages['image']);
					 ...
					 <span id="proofupload"  class="error-image" style="display:none;">Attach Proof has been upload successfully</span>                     </div>
         ...
         <div class="col-md-4">
            <div class="profile_status">
			   ...
			   <label class="form-check-label text_bold pb-3  w-100">                  <input type="radio" name="profile_status" id="pd" value="1" disabled <?php if(($userprofile['user_plan']==0)) { echo "checked";}?>>Provide Details                   
			   </label>                  
			   <label class="form-check-label text_bold pb-3  w-100">                  <input  <?php if(($userprofile['user_plan'] > 0)) { echo "checked";} ?> type="radio" name="profile_status" id="a" value="2" disabled>Approval                  </label>               </div>
            </div>
         </div>
      </div>
   </div>
