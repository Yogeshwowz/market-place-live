            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>about-us">About Us <?php //echo"<pre>"; print_r($_SESSION);?></a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>buyers">Buyer</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>sellers">Seller</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>investors">Investor</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>">Advisory</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>">Resources</a>
                      </li>
                      <li class="nav-item">
