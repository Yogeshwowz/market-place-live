                    ...
                    <div class="main_box mb-4">
                        ...
                        <div class="box_body main_line p_20">
                            ...
                            <div class="d-flex flex-column black_border px-4 py-3 my-4 br_10">
                               <?php if(empty($userprofile['amount'])) { ?> <p class="pb-3">You have No Active Plan, Please upgrade to a premium plan to get your profile activated faster and start sending proposals to investors and acquirers</p><?php } else{ ?> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="latest_share justify-content-end d-flex m-0">
                                            ...
                                            <li><a href="tel:<?php if(!empty($allsellerProfile->user_phone)) { echo $allsellerProfile->user_phone;}?>"><i class="fa fa-phone pr-2" aria-hidden="true"></i>Phone</a></li>
                                        </ul>
                                    </div>
                                </div>
