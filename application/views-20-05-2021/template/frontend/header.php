            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                      ...
                      <li class="nav-item">
                        <a class="nav-link  <?php if(in_array('buyers',$url)) { echo "active";}?>" href="<?php echo base_url();?>buyers">Buyer</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link <?php if(in_array('sellers',$url)) { echo "active";}?>" href="<?php echo base_url();?>sellers">Seller</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link <?php if(in_array('investors',$url)) { echo "active";}?>" href="<?php echo base_url();?>investors">Investor</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link <?php if(in_array('advisory',$url)) { echo "active";}?>" href="<?php echo base_url();?>advisory">Advisory</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link <?php if(in_array('advisory',$url)) { echo "active";}?>" href="<?php echo base_url();?>">Resources</a>
                      </li>
                      <li class="nav-item">
