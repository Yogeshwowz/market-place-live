      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
		  ...
		  <?php /* <li class="nav-item">
              <a class="nav-link" href="#navbar-resources" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-resources">
                <i class="ni ni-shop text-primary"></i>
                <span class="nav-link-text">Resources</span>
              </a>
              <div class="collapse" id="navbar-resources">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="<?php echo base_url();?>administrator/buy" class="nav-link">
                      <span class="sidenav-mini-icon"> B </span>
                      <span class="sidenav-normal"> How to Buy </span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo base_url();?>administrator/sell" class="nav-link">
                      <span class="sidenav-mini-icon"> S </span>
                      <span class="sidenav-normal"> How to sell  </span>
                    </a>
                  </li>
				   <li class="nav-item">
                    <a href="<?php echo base_url();?>administrator/business-plan" class="nav-link">
                      <span class="sidenav-mini-icon"> P </span>
                      <span class="sidenav-normal"> How to create a business plan </span>
                    </a>
                  </li>
                </ul>
              </div>
  ...
  <!--            </a>-->
       ...
       <hr class="my-3">
          ...
          <ul class="navbar-nav mb-md-3">
            <li class="nav-item">
              <a class="nav-link <?php if(in_array('buyers',$url)){ echo "active"; }?> " href="<?php echo base_url();?>administrator/buyers" >
                <i class="ni ni-single-02"></i>
                <span class="nav-link-text">Buyers</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if(in_array('sellers',$url)){ echo "active"; }?> " href="<?php echo base_url();?>administrator/sellers" >
                <i class="ni ni-single-02"></i>
                <span class="nav-link-text">Sellers</span>
              </a>
            </li>
			<li class="nav-item">
              <a class="nav-link <?php if(in_array('investors',$url)){ echo "active"; }?> " href="<?php echo base_url();?>administrator/investors" >
                <i class="ni ni-single-02"></i>
                <span class="nav-link-text">Investors</span>
              </a>
            </li>
			<li class="nav-item">
              <a class="nav-link <?php if(in_array('advisory',$url)){ echo "active"; }?> " href="<?php echo base_url();?>administrator/advisory" >
                <i class="ni ni-single-02"></i>
