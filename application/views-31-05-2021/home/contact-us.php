<section class="contact_us_page d-flex flex-column justify-content-center align-items-center text-center bg_white"> 
  ...
  <div class="d-flex flex-column text-center justify-content-center align-items-center p_20">
                    ...
                    <p>XYZ Online Services Pvt Ltd</p>
                    <p>Hellos Business Park,</p>
                    <p>Level 10, Wing c, 150 Outer Ring Road,</p>
                    <p>Kadubeesanahali,Varhtur, Hobli</p>
                    <p>Singapore -123123</p>
                    <p>CIN: U1234567sdshs23243546</p>
                    <h4 class="mt-4">Follow Us</h4>
                    <ul class="d-flex pt-3">
                        <li class="px-3"><a href="#"><i class="fa fa-facebook p-1 mr-2" aria-hidden="true"></i>Facebook</a></li>
                        <li class="px-3"><a href="#"><i class="fa fa-google-plus p-1 mr-2" aria-hidden="true"></i>Google+</a></li>
                        <li class="px-3"><a href="#"><i class="fa fa-linkedin p-1 mr-2" aria-hidden="true"></i>Linkedin</a></li>
                    </ul>
                </div>			
        </div>
    </section>