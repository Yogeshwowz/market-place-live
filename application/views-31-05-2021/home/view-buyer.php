            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="main_box bg_white my-4 w-100">
                        <div class="p_20"><p>
                            <h5 class="color_blue"><?php if(!empty($userprofile['field_7'])) { echo $userprofile['field_7']; }?> looking to 							<?php if(!empty($userprofile['interested_in'])) { 							if($userprofile['interested_in']==1) { echo "Acquiring / Buying a Business";} 							if($userprofile['interested_in']==2) { echo "Investing in a Business";} 							if($userprofile['interested_in']==3) { echo "Lending to a Business";}							}?> in <?php if(!empty($userprofile['field_2'])) {  $businessindustry= unserialize($userprofile['field_2']);							  echo implode(',',$businessindustry);							}?> 																					</h5></p>
...
<div id="SendProposalsamerole" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="error">A Buyer Profile can send proposal to only Seller</p>
      </div>
    </div>
	  </div>
</div>
...
<div id="SendProposalamountempty" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="error">You can not send proposal. beacuse you have not a plan </p>
      </div>
    </div>
	  </div>
</div>
