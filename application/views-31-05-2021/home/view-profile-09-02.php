                            ...
                            <div class="row py-4">
                                ...
                                <div class="col-md-8 py-3">
                                   <p>
											...
											}else{?><i class="fa fa-lock pr-2" aria-hidden="true"></i><?php echo"Available after connect"; } }else { ?><i class="fa fa-lock pr-2" aria-hidden="true"></i><?php echo"Available after connect"; } ?></p>
                                </div>
								<div class="col-md-4 py-3">
				...
				<div class="col-md-4">
                    <div class="main_box bg_white my-4 w-100">
                        <div class="activity_body d-flex flex-column p_20">
							...
							<button type="button" class="user_btn mx-auto my-2" data-toggle="modal" data-target="#SendProposal">Send Proposal</button>
							<?php } else {?>
                            <button class="user_btn mx-auto my-2 send-proposal" rel="<?php echo $this->uri->segment(2);?>">Send Proposal </button><?php } ?>
							<?php } else { ?>
							<button class="user_btn mx-auto my-2" data-toggle="modal" data-target="#SendProposalnotlogin">Send Proposal </button>
							<?php } ?>
                        </div> 
                    ...
                    <a href="#">
                        <div class="c_box d-flex flex-column w-100">
                            ...
                            <div class="d-flex justify-content-between bg_color p-2 mb_2">
                                ...
                                <p><span>SGD</span><?php if(!empty($allbuyerProfile->field_4)) { echo $allbuyerProfile->field_4; }?> To <?php if(!empty($allbuyerProfile->investmentto)) { echo $allbuyerProfile->investmentto; }?></p>
                            </div>
                            <div class="d-flex justify-content-between bg_color p-2 mb_2">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>You are send Proposal alreadly.Now you can not be send proposal again</p>
      </div>
...
<div id="SendProposalnotlogin" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Without login, you can not send proposal</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
