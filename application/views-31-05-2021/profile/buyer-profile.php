         ...
         <div class="col-md-8 pr-5">
            ...
            <form  id="buyer-profile-frm" method="POST" action="" role="form" novalidate=""enctype="multipart/form-data" >
               <div class="pro_box bg_white my-4">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 mb-2 justify-content-between">                        
					 <label class="w-100 mb-1" for="email">Enter official email for quick verification</label>                        <input class="w-100 p-2" type="email" name="official_email" value="<?php if(!empty($userprofile['official_email'])) {echo  $userprofile['official_email'];}?>" required='true'>                    
					 </div>
                     <div class="col-md-6 mb-2 justify-content-between">                        
               ...
               <div class="pro_box requirement_box bg_white">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 mb-2">                        
					 <textarea  required='true' class="form-control" rows="3" name="field_6" id="field_6"><?php if(!empty($userprofile['field_6'])) {echo  $userprofile['field_6'];}?></textarea>                     
					 </div>
                     <div class="col-md-6 mb-2">                        
                     ...
                     <div class="col-md-6 mb-2">
                        <div id="img-preview" class="row">
                           ...
                           <div class="col-md-2" id="<?php echo $Gimages['pmid']; ?>">
							  ...
							  <span class="remove-image" onclick="removeimage(<?php echo $Gimages['pmid']; ?>)">X</span>                              </div>
                           </div>
                           <?php }                              
						   }?>                        
                        </div>
                     ...
                     <div class="col-md-6 mb-2" style="display:none;">                        
					 <input rel="image" Itype="buyer" style="display:none;" type="file" name="add_photo" id="add_photo"> <label for="add_photo" class="add_file_btn">Add Photos</label>                        
            ...
            <div class="pro_box requirement_box bg_white buy_plan_section">
               ...
               <div class="col-lg-8 col-md-12 mb-3">
                  <div class="d-flex">                     <input type="checkbox" class="form-check-input" value="1" name="accept">                     
				  <label class="form-check-label pb-3  w-100">                    
			   ...
			   <button id="buy-button" class="main-btn1 ml-auto py-2">Buy</button>               </div>
            </div>
         </div>
         <div class="col-md-4">
            <div class="profile_status">
               <h3>Your Profile Status</h3>
               <div class="profile_status_radio">                  <label class="form-check-label text_bold pb-3  w-100">                  <input type="radio" name="profile_status" id="pd" value="1" disabled <?php if(($userprofile['user_plan']==0)) { echo "checked";}?>>Provide Details                   </label>                  <label class="form-check-label text_bold pb-3  w-100">                  <input  <?php if(($userprofile['user_plan'] > 0)) { echo "checked";} ?> type="radio" name="profile_status" id="a" value="2" disabled>Approval                  </label>               </div>
            </div>
         </div>
      </div>
   </div>
