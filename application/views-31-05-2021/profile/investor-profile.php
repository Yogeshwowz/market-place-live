      ...
      <div class="col-md-8 pr-5">
        ...
        <form  id="buyer-profile-frm" method="POST" action="" role="form" novalidate=""enctype="multipart/form-data" >
          <div class="pro_box bg_white my-4">
            ...
            <div class="row">
			  ...
			  <input class="w-100 p-2" type="email" name="official_email" value="<?php if(!empty($userprofile['official_email'])) {echo  $userprofile['official_email'];}?>" required='true'>                     
			  </div>
              <div class="col-md-6 mb-2 justify-content-between">                        
        ...
        <div class="pro_box requirement_box bg_white buy_plan_section">
          ...
          <div class="col-lg-8 col-md-12 mb-3">
            <div class="d-flex">                    
			<input type="checkbox" class="form-check-input" value="1" name="accept">                     <label class="form-check-label pb-3  w-100">                     I accept the Terms of Engagement                      </label> </div>
