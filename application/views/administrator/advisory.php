            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo base_url();?>administrator/advisory">Manage Advisory</a></li>
              ...
              <table class="table table-flush" id="datatable-basic">
				...
				<?php foreach($users as $users) { ?>
                  <tr>
                    ...
                    <td><a  target="_blank" class="aeditclass" href="<?php echo base_url();?>administrator/view-advisory/<?php echo base64_encode($users->id)?>">view</a>
					|<span rel="<?php echo $users->id;?>" class="delete-admin-user">Delete</span> |
