            ...
            <!-- Card header -->
             <div class="row">
			  <?php 
				...
				<?php } ?>
                <form  action="<?php echo base_url();?>administrator/create-testimonial" method="post" role="form" novalidate=""   id="my_testimonial" enctype="multipart/form-data">
					...
					<div class="form-row">
                      ...
                      <input type="text" name="subtitle" class="form-control"   required="true"  placeholder="Sub Title">
                      </div>
					</div>
					 <div class="form-row">
                    <div class="col-md-12 ">
                      <label class="form-control-label" for="editor1">Message</label>
                      <textarea  name="description" type="text" class="form-control"  placeholder="Message"  required="true"></textarea>
