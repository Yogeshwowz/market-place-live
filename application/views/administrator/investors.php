              ...
              <table class="table table-flush" id="datatable-basic">
				...
				<?php foreach($users as $users) { ?>
                  <tr>
                    ...
                    <td><a  target="_blank" class="aeditclass" href="<?php echo base_url();?>administrator/view-investor/<?php echo base64_encode($users->id)?>">view</a>|<span rel="<?php echo $users->id;?>" class="delete-admin-user">Delete</span> |
