...
?>
<form role="form" action="<?php echo base_url();?>buyers" method="post" id="search-form-buyer">
<section class="search_result_page">
        <div class="row p-0 m-0">
                    ...
                    <div class="result_left_top">
                        ...
                        <div class="result_left_bottom px_60">
                                    ...
                                    <div class="card-body">
                                       <?php foreach($array['Youarean'] as $key=>$Youarean ) { ?>
                                        <label class="form-check-label text_bold">
                                            <input class ="search-filter-buyer" type="checkbox" name="field_1[]" id="bp_<?php echo  $key;?>" value="<?php echo  $key;?>" ><?php echo $Youarean;?>
                                        </label>
                                      <?php }  ?>
                                    </div>
                                 </div>
							...
							<div class="drop_filter py-3 bb_1">
                                 ...
                                 <div id="collapsesix2" class="collapse" aria-labelledby="headingsix" data-parent="#business_drop_filter_1">
                                    <div class="card-body">
                                         <label class="form-check-label text_bold">
                                            <input class="search-filter-buyer" type="checkbox" name="interested_in[]" id="bp_1" value="1" >Acquiring / Buying a Business
                                        </label>
										<label class="form-check-label text_bold">
                                            <input class="search-filter-buyer" type="checkbox" name="interested_in[]" id="mp_1" value="2">Investing in a Business
                                        </label>
                                        <label class="form-check-label text_bold">
                                            <input class="search-filter-buyer" type="checkbox" name="interested_in[]" id="pp_1" value="3">Lending to a Business
                                        </label>
                                    </div>
                                 </div>
                              </div>	
						...
						<div class="accordion" id="business_drop_filter_2">
                              ...
                              <div class="drop_filter py-3 bt_1 bb_1">
                                 <button class="drop_filter_btn p-0" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                    <b>Investment Size</b>
                                    <div class="faq_icon"></div>
                                 </button>
                                 <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#business_drop_filter">
                                    <div class="card-body">
                                       <div class="row mt-2">
                                          ...
                                          <div class="col-md-4">
                                             <select id="invest-1" name="invest-1" class="investclsbuyer">
                                          ...
                                          <div class="col-md-4">
                                             <select id="invest-2" name="invest-2" class="investclsbuyer">
                                          ...
                                          <div class="col-md-4">
                                             <select id="invest-3" name="invest-3" class="investclsbuyer">
                                          ...
                                          <div class="col-md-4">
                                             <select  id="invest-4" name="invest-4" class="investclsbuyer">
                                                <option value="K">K</option>
                                                <option value="M">M</option>
                                                <option value="B">B</option>
                                             </select>
									 ...
									 <div class="py-2">
                                        ...
                                        <button class="btn filter_search_btn my-2 my-sm-0" type="submit">Locations<i class="fa fa-map-marker  pl-2" aria-hidden="true"></i></button>
                                          <input name="field_5" class="filter_search search-filter-buyer-address" type="search" placeholder="Filter.." aria-label="Search">   
										  </div>                                   
                                     </div>
                                </div>
			...
			<div id='pagination_buyer' class="text-center my-5 v-page"></div>
