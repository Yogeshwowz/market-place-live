        ...
        <div class="banner_create_profile">
            <div class="container-fluid">
                <div class="row justify-content-between p-0 m-0">
                    ...
                    <div class="col-md-3 text-center pb-4 pb-lg-0">
                    ...
                    <div class="col-md-3 text-center pb-4 pb-lg-0">
                        <a href="#" data-toggle="modal" data-target="#basicExampleModal"><button class="main_btn2 bg_btn_color3 mt-3">Create Advisor Profile</button></a>
                    </div> 
                </div>
            </div>
        </div><?php } ?>
			...
			<div class = "row">
				<div class = "col-6 new6">
					<div class = "industry-content">
						...
						<button class = "industry-link">Explore Industry Watch</button>
					</div>
				</div>
				<div class = "col-6">
			...
			<div class = "row">
				...
				<div class = "col-6">
					<div class = "industry-content">
						...
						<button class = "industry-link" >Explore Industry Guide</button>
					</div>
				</div>
			</div>
		</div>
                ...
                <div class="col-md-12 px-0 " style="">
                    ...
                    <div class="col-md-12 px-0 p-t-30 ">
						...
						<?php foreach($testimonial as $testimonial) { ?>
							...
							<P class = "userImg">
							<img class = "testi-img" src = "<?php echo base_url();?>/assets/upload/<?php if(!empty($testimonial->image)) { echo $testimonial->image; } ?>" alt = "image of testimonial"><span class = "userName"><?php if(!empty($testimonial->name)) { echo $testimonial->name; } ?></span>
							<p class = "profiles"><img class="img-testUser" src="assets/img/user.png">
							<?php if(!empty($testimonial->title)) { echo $testimonial->title; } ?>
							</p>
							</p>
							<div class = "green-tag">
							<span class="circle"></span>
							<p><?php if(!empty($testimonial->subtitle)) { echo $testimonial->subtitle; } ?></p>
							</div>
							<div class = "testi-content">
							<p  class="complete1 full" id="test_full_<?php echo $testimonial->id;  ?>"><?php if(!empty($testimonial->description)) { 
									echo $testimonial->description;  } ?><span class="less" rel="<?php echo $testimonial->id;?>">Less...</span></p>
							
							<p  class="half"  id="test_half_<?php echo $testimonial->id;  ?>"><?php if(!empty($testimonial->description)) { 
							$string = $testimonial->description;
							
								if( strlen( $string ) > 100 ) {
										echo $string = substr( $string, 0, 100 ) . '<span class="more" rel="'. $testimonial->id.'">More...</span>';
								}
