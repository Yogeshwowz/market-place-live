				...
				<div class="col-md-4">
                    <div class="main_box bg_white my-4 w-100">
						...
						if($Bookmarkcount >0) { ?>
						 ...
						 <?php }else{
							 if(in_array('view-buyer',$url)){ $role=2; }
							 if(in_array('view-investor',$url)){ $role=1; }
							 ?>
						 
                            <li><a  href="javascript:;" class="send-bookmark" role="<?php echo $role;?>" rel="<?php echo $this->uri->segment(2);?>"><i class="fa fa-bookmark pr-3" aria-hidden="true" ></i>Bookmark</a></li>
						 <?php } 
						}else { ?>
								 <li><a  href="javascript:;"  data-toggle="modal" data-target="#SendBookmarknotlogin" ><i class="fa fa-bookmark pr-3" aria-hidden="true" ></i>Bookmark</a></li><?php 
						} ?>
						...
						<?php if(in_array('view-buyer',$url)){ ?>
							<input readonly type="text"  class="col-md-12" id="copyTarget" value="<?php echo base_url();?>view-buyer/<?php echo $this->uri->segment(2);?>"> 
						<?php } ?>
						<?php if(in_array('view-investor',$url)){ ?>
							<input readonly type="text"  class="col-md-12" id="copyTarget" value="<?php echo base_url();?>view-investor/<?php echo $this->uri->segment(2);?>"> 
						<?php } ?>
						<br>
							<span id="msg"></span><br>
                    </div>
