                ...
                <div class="col-md-4">
                    <div class="main_box bg_white my-4 w-100">
                        ...
                        <div class="activity_body d-flex flex-column p_20">    <p class="py-2 text-center">To engage serious businesses, sending proposals is allowed only on premium plans.</p>
						 ...
						 <?php }else{?>
                            <li><a  href="javascript:;" class="send-bookmark" role="3" rel="<?php echo $this->uri->segment(2);?>"><i class="fa fa-bookmark pr-3" aria-hidden="true" ></i>Bookmark</a></li>
						 <?php } 
						 }else{ ?>
						...
						<input readonly type="text"  class="col-md-12" id="copyTarget" value="<?php echo base_url();?>view-profile/<?php echo $this->uri->segment(2);?>"> <br>
							<span id="msg"></span><br>
                    </div>
                </div>
            </div>
