      ...
      <div class="col-md-6 col-lg-4 py-3 py-md-4">
         <div class="item">
            ...
            <div class="box2 colo-btn boxcls">
               <input  checked type="radio" name="paymentMethod" autocomplete="off" class="radio-disable radiobtnpayment radio-active" value="stripe"> BUY NOW
            </div>
         </div>
      </div>
                  ...
                  <div class='form-row row'>
                     ...
                     <div class='col-xs-12 col-md-6 form-group required'>
						...
						<?php $plan= $this->uri->segment(2);
						  ...
						  if($planid==2){$amount = 125;}
						  if($planid==3){$amount = 240;}
						  if($planid==4){$amount = 360;}
						?>
						<input  required
