            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <ul class="footer_list">
                            ...
                            <li><a href="<?php echo base_url();?>about-us">About Us</a></li>
							 <li><a href="<?php echo base_url();?>buy">How to Buy</a></li>
                            <li><a href="<?php echo base_url();?>sell">How to Sell</a></li>
                            <li><a href="<?php echo base_url();?>business-plan">How to create a business plan</a></li>
                    ...
                    <div class="col-md-3">
                        <h4>Get Started</h4>
                        <ul class="footer_list">
                             <li><a href="<?php echo base_url();?>buyers">Buyer</a></li>
                            <li><a href="<?php echo base_url();?>sellers">Seller</a></li>
                            <li><a href="<?php echo base_url();?>investors">Investor</a></li>
							<li><a href="<?php echo base_url();?>advisory">Advisory</a></li>
                        </ul>
                    </div>
                    <div class="col-md-2">
                        <h4>Follow Us </h4>
...
<?php if(in_array('bookmarks',$furl) ) { ?>
  <!-- Data Table ---->
