                    ...
                    <div class="ml-auto d-flex align-items-center">
                        ...
                        <div class="dropdown mr-1">
                                ...
                                <div class="dropdown-menu profile_dropdown p-0" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="<?php echo base_url();?>bookmarks"><i class="fa fa-bookmark pr-2" aria-hidden="true"></i>Bookmarks & History</a>
									...
									<?php if($this->session->userdata('role')==4){ ?>
										<a class="dropdown-item" href="<?php echo base_url();?>advisory-setting"><i class="fa fa-bell pr-2" aria-hidden="true"></i>Settings</a>
									<?php } ?>
